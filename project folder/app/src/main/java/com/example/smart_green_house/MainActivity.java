...
public class MainActivity extends AppCompatActivity {
    ...
    String temp, hum,mpump,soilmoisture;
...
//-------------------------------------------Btn Lamp ----------------------------
        ...
        mFirebaseBtnLamp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if((cnt % 2) == 0 ){   dref.child("onlamp").setValue("1") ;

                    mFirebaseBtnLamp.setTextColor(col1);
                    cnt++;
                }
                else {
                    dref.child("onlamp").setValue("0") ;
...
//-------------------------------------------Btn FAN  ----------------------------
        ...
        mFirebaseBtnFan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if((cnt % 2) == 0 ){   dref.child("onfun").setValue("1") ;

                    mFirebaseBtnFan.setTextColor(col1);
                    cnt++;
                }
                else {
                    dref.child("onfun").setValue("0") ;
